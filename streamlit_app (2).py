...
with st.sidebar:
    ...
    # Faster defaults (you can still add other windows as needed)
    learn_opts = st.multiselect(
        "Learning window candidates (transitions)",
        [120, 180, 240],
        default=[120],
        help="Defaults to the fastest setting (120). You can add 180/240 if you want a slower, broader calibration.",
    )
    val_opts = st.multiselect(
        "Validation window candidates (transitions)",
        [60, 90, 120],
        default=[60],
        help="Defaults to the fastest setting (60). You can add 90/120 if you want a longer validation slice.",
    )
