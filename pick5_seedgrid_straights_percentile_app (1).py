...
def _load_default_loserlist_filters():
    """Try to load LoserList filters from the repo (optional)."""
    # Keep this flexible: Streamlit/GitHub sometimes appends (1), (2), etc.
    candidates = [
...
st.dataframe(df_remaining.head(100), use_container_width=True)
